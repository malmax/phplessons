<?php /* Smarty version 2.6.30, created on 2016-11-22 15:37:01
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'index.tpl', 1, false),array('modifier', 'capitalize', 'index.tpl', 16, false),array('modifier', 'date_format', 'index.tpl', 20, false),)), $this); ?>
...
$this->_sections['sec1']['loop'] = is_array($_loop=$this->_tpl_vars['menu']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
        <li><a href="./index.php?page=<?php echo $this->_tpl_vars['menu'][$this->_sections['sec1']['index']]['url']; ?>
"><?php echo $this->_tpl_vars['menu'][$this->_sections['sec1']['index']]['title']; ?>
</a></li>
    <?php endfor; endif; ?>
</ul>
...
Дата: <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M:%S")); ?>
